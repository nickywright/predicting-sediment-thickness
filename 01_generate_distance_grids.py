...
rotation_filenames = [
    '%s/Global_250-0Ma_Rotations.rot' % data_dir,
    '%s/Global_410-250Ma_Rotations.rot' % data_dir,
    '%s/Alps_Mesh_Rotations.rot' % data_dir,
    '%s/Andes_Flat_Slabs_Rotations.rot' % data_dir,
    '%s/Andes_Rotations.rot' % data_dir,
    '%s/Australia_Antarctica_Mesh_Rotations.rot' % data_dir,
    '%s/Australia_North_Zealandia_Rotations.rot' % data_dir,
    '%s/Eurasia_Arabia_Mesh_Rotations.rot' % data_dir,
    '%s/North_America_Flat_Slabs_Rotations.rot' % data_dir,
    '%s/North_America_Mesh_Rotations.rot' % data_dir,
    '%s/North_China_Mesh_Rotations.rot' % data_dir,
    '%s/South_Atlantic_Rotations.rot' % data_dir,
    '%s/South_China_DeformingModel.rot' % data_dir,
    '%s/Southeast_Asia_Rotations.rot' % data_dir,
]

topology_filenames = [
    '%s/Alps_Deforming_Mesh.gpml' % data_dir,
    '%s/Alps_Mesh_Topologies.gpml' % data_dir,
    '%s/America_Anyui_Deforming_Mesh.gpml' % data_dir,
    '%s/America_Anyui_Mesh_Topologies.gpml' % data_dir,
    '%s/Andes_Deforming_Mesh.gpml' % data_dir,
    '%s/Andes_Flat_Slabs_Topologies.gpml' % data_dir,
    '%s/Andes_Mesh_Topologies.gpml' % data_dir,
    '%s/Arctic_Eurasia_Deforming_Mesh.gpml' % data_dir,
    '%s/Arctic_Eurasia_Mesh_Topologies.gpml' % data_dir,
    '%s/Australia_Antarctica_Deforming_Mesh.gpml' % data_dir,
    '%s/Australia_Antarctica_Mesh_Topologies.gpml' % data_dir,
    '%s/Australia_North_Zealandia_Deforming_Mesh.gpml' % data_dir,
    '%s/Australia_North_Zealandia_Mesh_Topologies.gpml' % data_dir,
    '%s/Baja_Deforming_Mesh.gpml' % data_dir,
    '%s/Coral_Sea_Deforming_Mesh.gpml' % data_dir,
    '%s/Coral_Sea_Topologies.gpml' % data_dir,
    '%s/East_African_Rift_Deforming_Mesh_and_Topologies.gpml' % data_dir,
    '%s/East-West_Gondwana_Deforming_Mesh_and_Topologies.gpml' % data_dir,
    '%s/Ellesmere_Deforming_Mesh.gpml' % data_dir,
    '%s/Eurasia_Arabia_Deforming_Mesh_and_Topologies.gpml' % data_dir,
    '%s/Global_Mesozoic-Cenozoic_PlateBoundaries.gpml' % data_dir,
    '%s/Global_Paleozoic_PlateBoundaries.gpml' % data_dir,
    '%s/Greater_India_Deforming_Mesh.gpml' % data_dir,
    '%s/Greater_India_Mesh_Topologies.gpml' % data_dir,
    '%s/Inactive_Meshes_and_Topologies.gpml' % data_dir,
    '%s/North_America_Mesh_Topologies.gpml' % data_dir,
    '%s/North_Atlantic_Deforming_Mesh.gpml' % data_dir,
    '%s/North_Atlantic_Mesh_Topologies.gpml' % data_dir,
    '%s/North_China_Mesh_Topologies.gpml' % data_dir,
    '%s/Northern_Andes_Deforming_Mesh.gpml' % data_dir,
    '%s/Northern_Andes_Mesh_Topologies.gpml' % data_dir,
    '%s/Papua_New_Guinea_Deforming_Meshes.gpml' % data_dir,
    '%s/Papua_New_Guinea_Mesh_Topologies.gpml' % data_dir,
    '%s/Scotia_Deforming_Mesh_and_Topologies.gpml' % data_dir,
    '%s/Siberia_Eurasia_Deforming_Mesh.gpml' % data_dir,
    '%s/Siberia_Eurasia_Mesh_Topologies.gpml' % data_dir,
    '%s/South_Atlantic_Deforming_Mesh.gpml' % data_dir,
    '%s/South_Atlantic_Mesh_Topologies.gpml' % data_dir,
    '%s/South_China_Mesh_Topologies.gpml' % data_dir,
    '%s/South_China_DeformingElements.gpml' % data_dir,
    '%s/South_Zealandia_Deforming_Mesh.gpml' % data_dir,
    '%s/South_Zealandia_Mesh_Topologies.gpml' % data_dir,
    '%s/Southeast_Asia_Deforming_Mesh.gpml' % data_dir,
    '%s/Southeast_Asia_Mesh_Topologies.gpml' % data_dir,
    '%s/West_Antarctic_Zealandia_Deforming_Mesh.gpml' % data_dir,
    '%s/West_Antarctica_Zealandia_Mesh_Topologies.gpml' % data_dir,
    '%s/Western_North_America_Deforming_Mesh.gpml' % data_dir,
    '%s/Western_Tethys_Deforming_Mesh.gpml' % data_dir,
    '%s/Western_Tethys_Tectonic_Boundary_Topologies.gpml' % data_dir]
